<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar">
        <a href="" class="flex mr-auto">
            <img alt="IMP Studio" class="w-6" src="{{ asset('images/IMP.png') }}">
        </a>
    ...
    <ul class="border-t border-white/[0.08] py-5 hidden">
        ...
        <li>
            <a href="{{ route('kehadiran') }}" class="menu {{ Request::is('*') ? 'menu--active' : '' }}">
                <div class="menu__icon"> <i data-lucide="users"></i> </div>
                <div class="menu__title"> Absensi Kehadiran </div>
            </a>
        </li>
        <li>
            <a href="{{ route('cuti') }}" class="menu {{ Request::is('*') ? 'menu--active' : '' }}">
                <div class="menu__icon"> <i data-lucide="tag"></i> </div>
                <div class="menu__title"> Cuti </div>
            </a>
        </li>
        <li>
            <a href="{{ route('standup') }}" class="menu {{ Request::is('*') ? 'menu--active' : '' }}">
                <div class="menu__icon"> <i data-lucide="message-square"></i> </div>
                <div class="menu__title"> Standup </div>
            </a>
        </li>
        <li>
            <a href="{{ route('divisi') }}" class="menu {{ Request::is('*') ? 'menu--active' : '' }}">
                <div class="menu__icon"> <i data-lucide="clipboard"></i> </div>
                <div class="menu__title"> Divisi </div>
            </a>
        </li>
        <li>
            <a href="{{ route('employee') }}" class="menu {{ Request::is('*') ? 'menu--active' : '' }}">
                <div class="menu__icon"> <i data-lucide="users"></i> </div>
