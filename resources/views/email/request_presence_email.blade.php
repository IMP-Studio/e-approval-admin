                            ...
                            <div style="padding: 0px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent;">
                                <div style="padding: 10px; text-align: start; background-color: #1B253B;">
                                    ...
                                    <p style="color: #CBD5E1; font-family: Verdana; font-size: 12px;margin-bottom: 3px">
                                        <span style="font-weight: 600; font-size: 15px; color: #CBD5E1; text-align: start;text-transform:capitalize;">Hi, {{$approvers->name}}.</span> 
                                    </p>
                                    @php
                                    ...
                                    <p style="font-family: Verdana;">
                                      <span style="font-weight: 400; color: #CBD5E1; font-size: 13px;">{{ $user->name }} telah mengajukan Presensi <span style="font-weight: bold">{{$categoryPresence}}</span></span>
                                    </p>
                                    <p style="font-family: Verdana;">
                                    ...
                                    <p style="font-family: Verdana;">
                                        ...
                                        @endif
                                        <span style="font-weight: 400; color: #CBD5E1 ;font-size: 13px;text-transform:capitalize;">Tanggal Pengajuan : <span style="font-weight: bold">{{ \Carbon\Carbon::parse($presence->date)->format('d F Y H:i A') }}</span></span>
                                    </p>
                                    <p><br></p>
                                    {{-- KALAU ADA WFA + other --}}
                                        ...
                                        <a href="{{ config('app.url') }}/storage/{{ $workTrip->file }}" style="text-decoration: none; color: #CBD5E1;">
                                            <span style="padding: 10px; border: none; background-color: #28334E; border-radius: 10px; display: inline-block; cursor: pointer;">
                                                <span style="font-weight: 400; font-size: 13px; text-transform: initial; font-family: Verdana;">
                                                  <img align="center" border="0" src="{{ asset('/images/icons8-file.svg') }}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 25px;"/> 
                                                    File Work Trip
                                                </span>
                                            </span>
                                        </a>
                                    ...
                                    <p style="font-family: Verdana;">
                                        <span style="font-weight: 400; color: #CBD5E1 ;font-size: 12px;text-transform:initial;">Diharapkan Anda dapat merespon secepatnya.</span>
                                    </p>
                                    <p><br></p>
                                </div>
                            </div>
