            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="text-center whitespace-nowrap">Jenis Cuti</th>
                        <th class="text-center whitespace-nowrap">Jumlah hari</th>
                    ...
                    <tr class="intro-x h-16">
                        ...
                        <td class="flex justify-center align-center">
                            <div class="w-12 h-12 image-fit zoom-in">
                                <img data-action="zoom" class="tooltip rounded-full" src="{{ asset('images/IMP.png') }}">
                            </div>
                        </td>
