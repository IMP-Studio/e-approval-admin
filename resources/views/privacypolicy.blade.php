...
<body>
    ...
    <ul>
        ...
        <li>
            <p><strong>Application</strong> refers to Approval, the software program provided by the Company.</p>
        </li>
        <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
                refers to PT Informatika Media Pratama, Gg. Mekar VII No.11, RT.11/RW.9, Cijantung, Kec. Ps. Rebo, Kota
                Jakarta Timur, Daerah Khusus Ibukota Jakarta 13770.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to E-Approval, accessible from <a
                    href="https://admin.approval.impstudio.id/" rel="external nofollow noopener"
                    target="_blank">https://admin.approval.impstudio.id/</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>
            <p>By visiting this page on our website: <a href="https://impstudio.id" rel="external nofollow noopener"
                    target="_blank">https://impstudio.id</a></p>
        </li>
        <li>
            <p>By phone number: 08127992049</p>
        </li>
    </ul>
