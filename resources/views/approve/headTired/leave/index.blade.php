                        ...
                        <tr class="intro-x h-16">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    @can('reject_presence')                                        
                                    <a data-rejectLeaveHtid="{{ $item->leave->statusCommit->first()->id }}" data-rejectmessageLeaveHt="{{ $item->user->name }} {{ $item->category }}" class="flex items-center text-danger reject_leave_Ht" data-id=""
                                        data-name="" href="javascript:;" data-tw-toggle="modal"
