        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <div class="text-center">
                    ...
                    data-tw-target="#modal-store-divisi" class="btn btn-primary mr-2">Add New Partner</a>
                </div>
                ...
                <table id="table" class="table table-report -mt-2">
                    ...
                    <tbody>
                        ...
                        <div id="modal-edit-divisi-{{ $item->id }}" class="modal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form id="edit-form" method="POST" action="{{ route('partner.update',$item->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                            <div class="col-span-12">
                                                <label for="modal-form-2" class="form-label">Nama Divisi</label>
                                                <input id="modal-form-2" value="{{ $item->name }}" name="partner" type="text" class="form-control" placeholder="nama divisi">
                                            </div>
                                        </div>
                        ...
                        <div id="delete-confirmation-modal-{{ $item->id }}" class="modal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="delete-form" method="POST" action="{{ route('partner.destroy',$item->id) }}">
                                        @csrf
                                        @method('delete')
                                        <div class="modal-body p-0">
                                            <div class="p-5 text-center">
                                                ...
                                                <div class="text-slate-500 mt-2">
                                                    Please type the Partner name "{{ $item->name }}" of the data to confrim.
                                                </div>
                ...
                <form action="{{ route('partner.store') }}" method="post">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12">
                            ...
                            <input id="modal-form-1" name="partner" type="text" class="form-control capitalize" placeholder="Name Partner" autocomplete="off">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-20 mr-1">Cancel</button>
